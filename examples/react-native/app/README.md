...
- [`package.json`](package.json) declares `"amplitude-rn-analytics": "workspace:*"` so the example consumes local SDK source instead of the published version.
